...
module.exports = class Gateway extends GenericDevice {
    constructor(sid, model, parent) {
        ...
        this.parent._sendSocket({ cmd: "get_id_list", sid: sid });
        this.parent._sendSocket({ cmd: "read", sid: sid });
        this.token = '';
        this.illumination = 0;
        this.rgb = 0;
    }
    ...
    _writeGateway(data) {
        this.parent._sendSocket({ cmd: "write", model: "gateway", sid: this.sid, short_id: 0, data: data });
    }
